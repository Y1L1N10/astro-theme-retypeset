...
export const themeConfig: ThemeConfig = {
  ...
  color: {
    ...
    light: {
      ...
      highlight: 'oklch(0.73 0.18 60 / 0.5)', // rgba(226, 131, 30, 0.45)
    },
    dark: {
      // primary color
      ...
      // highlight color
      highlight: 'oklch(0.73 0.18 60 / 0.2)', // rgba(255, 128, 0, 0.6)
    },
  },
  // COLOR SETTINGS >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> END
  ...
  comment: {
    ...
    waline: {
      ...
      serverURL: 'https://blog-comment-nine-vert.vercel.app',
      // 管理后台：https://blog-comment-nine-vert.vercel.app/ui
  ...
  footer: {
    ...
    links: [
      ...
      {
        name: 'GitHub',
        url: 'https://github.com/Y1L1N10',
      },
      {
        name: 'Email',
        url: 'yyilin000@gmail.com',
      },
      // {
      //   name: 'X',
